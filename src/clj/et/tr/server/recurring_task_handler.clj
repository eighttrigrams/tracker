...
(defn list-recurring-tasks-handler
  ...
  Query params: q (search term), context, strict (\"true\"/\"false\"), and
  comma-separated category id lists people, places, projects, goals. Categories
  are only forwarded to the query when at least one list is provided. Always
