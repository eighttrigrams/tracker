Feature: Meet over status on the today page
  ...
  Scenario: "Meet over" grays the card, clears maybe, and hides the maybe option
    ...
    And a meet "OverSync" with start date tomorrow exists
